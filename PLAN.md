...
- **v1.0.1 adjustment:** The user directed removal of the compact secondary weekly limit from the footer. The detailed `/usage` dashboard still shows all provider-reported windows; the footer now shows only the primary window.
